              ...
              ItemsName(
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (BuildContext) => FamilyTab()));
                },
              ),
              ItemsName(
                name: "Numbers",
                icon: const Icon(Icons.format_list_numbered,
                    size: 50, color: Color(0xffFEE1B7)),
                onTap: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(builder: (BuildContext) => NumbersTab()),
                  );
                },
              ),
              ItemsName(
                name: "Colors",
                icon:
                    const Icon(Icons.color_lens, size: 50, color: Color(0xffFEE1B7)),
                onTap: () {
                  Navigator.of(context).push(
                      MaterialPageRoute(builder: (BuildContext) => ColorTab()));
                },
              ),
              ItemsName(
                name: "Phrases",
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (BuildContext) => PhasesTab()));
                },
              ),
            ],
          ),
